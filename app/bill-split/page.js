      ...
      <div className="bg-gradient-to-b from-white to-[#FFF0E5] py-8 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center text-sm text-gray-500 mb-2">
            ...
            <span className="text-[#FF8C42]">Bill Split</span>
          </div>
          
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="bg-[#2563EB] p-3 rounded-lg mr-4 text-white">
                <Receipt size={24} />
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 bg-[#EBF4FF] border border-[#93C5FD] rounded-lg p-4 text-[#2D3748]">
            ...
            <ul className="ml-6 list-disc text-sm text-gray-600 space-y-1">
              <li>Create new groups for each occasion (trip, dinner, etc.)</li>
              <li>Add all participants who shared expenses</li>
              <li>Record expenses with amounts and participants</li>
              <li>See who owes what to whom in the settlement tab</li>
              <li>Your groups and expenses are saved automatically</li>
            </ul>
          </div>
        </div>
      </div>
