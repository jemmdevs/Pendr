      ...
      <div className="bg-gradient-to-b from-white to-[#FFF0E5] py-8 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center text-sm text-gray-500 mb-2">
            ...
            <span className="text-[#FF8C42]">Text Editor</span>
          </div>
          
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="bg-[#FFB285] p-3 rounded-lg mr-4 text-white">
                <Type size={24} />
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 bg-[#EBF4FF] border border-[#93C5FD] rounded-lg p-4 text-[#2D3748]">
            ...
            <ul className="ml-6 list-disc text-sm text-gray-600 space-y-1">
              <li>Click anywhere in the editor area to start typing</li>
              <li>Use the toolbar to format your text</li>
              <li>Try Bionic Reader for enhanced reading experience</li>
              <li>Switch between different text case options in the Advanced menu</li>
              <li>Check word and character count at the bottom of the editor</li>
            </ul>
          </div>
        </div>
      </div>
